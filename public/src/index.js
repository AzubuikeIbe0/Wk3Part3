...
async function calcAdd() {
  ...
  // This function subtract the first number from the second number
  async function calcMinus() {
    ...
    // 1. Build the API URL, starting with BASE_URL
    const url = `${BASE_URL}/minus?a=${numA}&b=${numB}`;
    ...
    // This function Multiplies the first number and the second number
    async function calcMultiply() {
      ...
      // This function subtract the first number by the second number
...
function loadCalculator() {
    ...
    document.getElementById('btnSubtract').addEventListener('click', calcMinus);
